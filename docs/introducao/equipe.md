...
<div className="team-grid">
  <article className="team-card">
    ...
    <div className="team-card__content">
      ...
      <span className="team-card__role">Backend & Renderer</span>
    </div>
  </article>
  ...
  <article className="team-card">
    ...
    <div className="team-card__content">
      ...
      <span className="team-card__role">Backend & Plugin</span>
    </div>
  </article>
  ...
  <article className="team-card">
    ...
    <div className="team-card__content">
      ...
      <span className="team-card__role">UI/UX & Frontend</span>
    </div>
  </article>
...
<div className="partners-info">
  :::info Parceiros institucionais
  O HIVE foi desenvolvido em parceria entre o **SENAI Roberto Mange** e a **Robert Bosch Ltda**, como parte do programa de formação técnica em Desenvolvimento de Sistemas da ETS.
  :::
</div>